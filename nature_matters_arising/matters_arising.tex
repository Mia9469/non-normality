...
Code and numerical outputs reproducing all analyses and figures are available in
the accompanying repository (archived release to be cited on acceptance).
